...
export interface ResultTypes<Result, Context> {
    ...
    pipeline: ChainableCommander<Context extends {
        mapping: "resp3";
    } ? "resp3" : "resp2">;
}
export interface ChainableCommander<Mapping extends "resp2" | "resp3" = "resp2"> extends RedisCommander<{
    type: "pipeline";
    mapping: Mapping;
}> {
    length: number;
...
export type Result<T, Context extends ClientContext> = ResultTypes<T, Context>[Context["type"]];
export type Resp2<T> = {
    readonly __resp2: T;
};
export type Resp3<T> = {
...
export type RespShape<Resp2Result extends Resp2<unknown>, Resp3Result extends Resp3<unknown>, Context extends ClientContext> = Context extends {
    mapping: "resp3";
} ? Resp3Result["__resp3"] : Resp2Result["__resp2"];
export type VsimReply<T extends RedisValue[], V extends string | Buffer, Context extends ClientContext> = Extract<T[number], "WITHATTRIBS"> extends never ? Extract<T[number], "WITHSCORES"> extends never ? V[] : RespShape<Resp2<V[]>, Resp3<Resp3Map<Resp3Double<V>>>, Context> : Extract<T[number], "WITHSCORES"> extends never ? RespShape<Resp2<V[]>, Resp3<Resp3Map<V | null>>, Context> : RespShape<Resp2<V[]>, Resp3<Resp3Map<[score: Resp3Double<V>, attributes: V | null]>>, Context>;
